...
function baseData(overrides: Partial<CopilRapportData> = {}): CopilRapportData {
  return {
    ...
    sla: {
      ...
      ouverts: 1,
      tauxCloture: 50,
      delaiMoyenUrgenteHeures: 4,
      delaiMoyenStandardHeures: 12,
      delaiMedianUrgenteHeures: 4,
      delaiMedianStandardHeures: 12,
      priseEnChargeMesuree: 2,
    },
    ticketsUrgentsLents: [{ site: 'Dakar', dateDeclaration: '01/04/2026', delaiHeures: 4 }],
