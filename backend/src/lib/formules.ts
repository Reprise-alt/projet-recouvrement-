...
//   PME     (65k) : ≤ 500 débiteurs · 5 utilisateurs · multi-entités · reporting
//   Grands comptes: illimité · reporting · contentieux inclus · multi-entités
// Le module contentieux est inclus pour Grands comptes, sinon disponible en
// option payante (+10 000/mois) via optionContentieux.
...
export function capacites(formule: string, optionContentieux = false): Capacites {
  switch (formule) {
    ...
    case 'pme':
      return { maxUtilisateurs: 5, maxDebiteurs: 500, reporting: true, contentieux: optionContentieux, multiEntites: true };
    case 'petite':
    default:
